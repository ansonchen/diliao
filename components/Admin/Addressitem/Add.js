...
import { Select, Radio, Checkbox, Button, DatePicker, TimePicker,Input, InputNumber, Form, Cascader, Icon, message,Switch  } from 'antd';
...
let Demo = React.createClass({
  ...
  render() {
    ...
    const { desc,beginDate,endDate,addressId,allowReg,finished} = this.state;
    ...
    return (
      <Form horizontal >
        ...
        {getFieldDecorator('finished',{
             ...
             initialValue: finished == 1 ? true:false,
